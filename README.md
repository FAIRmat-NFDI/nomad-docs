...
When contributing, please check the <a href="https://github.com/FAIRmat-NFDI/nomad-docs/blob/main/guides/writing_guide.md" target="_blank" rel="noopener">writing guide</a> for best practices.
