...
See [Supported Parsers](https://nomad-lab.eu/prod/v1/staging/docs/reference/parsers.html) for a full list of supported codes, mainfiles, auxiliary files, etc.

## Archive sections relevant for computational data

Under the [`Entry` section of the metainfo browser](https://nomad-lab.eu/prod/v1/gui/analyze/metainfo/nomad.datamodel.datamodel.EntryArchive), there are several sections and quantities being populated by the parsers. For computational data, the relevant sections are:
