...
NOMAD is available in two flavours to address the diverse needs of scientists: [**Central NOMAD**](https://nomad-lab.eu/nomad-lab/nomad.html) and [**NOMAD Oasis**](https://nomad-lab.eu/nomad-lab/nomad-oasis.html). To learn more about these solutions, refer to our [web page](https://nomad-lab.eu/).
...
There are multiple access points to NOMAD. The general [*landing page*](https://nomad-lab.eu/nomad-lab/) provides an overview of NOMAD’s features, along with links to documentation, tutorials, and project history.
...
1. [**Official**](https://nomad-lab.eu/prod/v1/gui/search/entries) – The latest stable version of NOMAD.

    Access it by clicking the "Open NOMAD" button at the top of the landing page.

2. [**Test**](https://nomad-lab.eu/prod/v1/test/gui/search/entries) – Runs the latest released version of NOMAD but on temporary test data that is routinely wiped.
