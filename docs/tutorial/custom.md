...
1) a tabular data file must be dragged in the annotated [quantity](../howto/schemas/yaml.md#quantities) in order for NOMAD to parse it (the quantity is called `data_file` in the following examples)
