...
Use this page if you need an account for NOMAD Central before following tutorials or using features such as uploading, sharing, publishing, or analyzing your own data.
...
<div class="image-slider" id="account-slider-create">
    <div class="nav-arrow left" id="account-prev-create">←</div>
    <img src="images/account_1.png" alt="Open the NOMAD login page and choose to register" class="active">
    <img src="images/account_2.png" alt="Open the registration form" >
    <img src="images/account_3.png" alt="Fill in the registration details" >
    <img src="images/account_4.png" alt="Complete account creation" >
    <div class="nav-arrow right" id="account-next-create">→</div>
</div>
...
<div class="image-slider" id="account-slider-aai">
    <div class="nav-arrow left" id="account-prev-aai">←</div>
    <img src="images/account_1.png" alt="Open the NOMAD login page" class="active">
    <img src="images/account_5.png" alt="Choose Helmholtz AAI login" >
    <img src="images/account_6.png" alt="Select your institution or social account" >
    <div class="nav-arrow right" id="account-next-aai">→</div>
</div>
