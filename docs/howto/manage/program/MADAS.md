...
A more comprehensive documentation with tutorials can be found [here](https://madas.readthedocs.io). `MADAS` is an open-source Python package, the code can be found on [GitHub](https://github.com/kubanmar/madas).