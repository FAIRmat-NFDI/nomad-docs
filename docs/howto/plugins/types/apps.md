...
Apps only affect the way data is *displayed* for the user: if you wish to affect the underlying data structure, you will need to write a [Python schema package](../../schemas/python.md) or a [YAML schema package](../../schemas/yaml.md).
