...
There is one
[main NOMAD project](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR){:target="_blank" rel="noopener"}
(and its [fork on GitHub](https://github.com/nomad-coe/nomad){:target="_blank" rel="noopener"}).
...
[MatID](https://github.com/nomad-coe/matid){:target="_blank" rel="noopener"},
[DOS fingerprints](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-dos-fingerprints){:target="_blank" rel="noopener"},
and the
[NOMAD Remote Tools Hub](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-remote-tools-hub){:target="_blank" rel="noopener"}.

!!! note
    The GitLab organization
    [nomad-lab](https://gitlab.mpcdf.mpg.de/nomad-lab){:target="_blank" rel="noopener"} and the GitHub
    organizations for [FAIRmat](https://github.com/fairmat-nfdi){:target="_blank" rel="noopener"} and the
    [NOMAD CoE](https://github.com/nomad-coe){:target="_blank" rel="noopener"} all represent larger
...
- `tests`: Tests ([pytest](https://docs.pytest.org){:target="_blank" rel="noopener"}) for the NOMAD code.
...
- `app`: The [FastAPI](https://fastapi.tiangolo.com/){:target="_blank" rel="noopener"} APIs: v1 and v1.2
  NOMAD APIs,
  [OPTIMADE](https://www.optimade.org/){:target="_blank" rel="noopener"},
  [DCAT](https://www.w3.org/TR/vocab-dcat-2/){:target="_blank" rel="noopener"},
  [h5grove](https://github.com/silx-kit/h5grove){:target="_blank" rel="noopener"}, and more.
...
- `cli`: The command line interface (based on
  [Click](https://click.palletsprojects.com){:target="_blank" rel="noopener"}). Subcommands are
  structured into submodules.

- `config`: NOMAD is configured through the `nomad.yaml` file. This contains all the
  ([Pydantic](https://docs.pydantic.dev/){:target="_blank" rel="noopener"}) models and default config
  parameters.
...
- `processing`: It's all about processing uploads and entries. The interface to
  [Celery](https://docs.celeryq.dev/en/stable/){:target="_blank" rel="noopener"} and
  [MongoDB](https://www.mongodb.com){:target="_blank" rel="noopener"}.
...
- `search.py`: The interface to
  [Elasticsearch](https://www.elastic.co/guide/en/enterprise-search/current/start.html){:target="_blank" rel="noopener"}.

## GUI code

The NOMAD UI is written as a [React](https://react.dev/){:target="_blank" rel="noopener"} single-page
application (SPA). It uses (among many other libraries)
[MUI](https://mui.com/){:target="_blank" rel="noopener"},
[Plotly](https://plotly.com/python/){:target="_blank" rel="noopener"}, and
[D3](https://d3js.org/){:target="_blank" rel="noopener"}. The GUI code is maintained in the `gui`
directory. Most relevant code can be found in `gui/src/components`. The application entry
point is `gui/src/index.js`.

## Documentation

The documentation is based on [MkDocs](https://www.mkdocs.org/){:target="_blank" rel="noopener"}. The
...
- `nomad/mkdocs.py`: Python code that defines
  [macros](https://mkdocs-macros-plugin.readthedocs.io/){:target="_blank" rel="noopener"} which can be
  used in Markdown.
