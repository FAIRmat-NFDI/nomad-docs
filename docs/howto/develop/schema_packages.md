...
This documentation shows you how to create a plugin entry point for a schema package. You should read the [introduction to plugins](../plugins/plugins.md) to have a basic understanding of how plugins and plugin entry points work in the NOMAD ecosystem.
...
See the documentation on [plugin development guidelines](../plugins/plugins.md#plugin-development-guidelines) for more details on the best development practices for plugins, including linting, testing and documenting.
...
The NOMAD Python package provides utilities to [query large amounts of archive data](../manage/program/archive_query.md).
