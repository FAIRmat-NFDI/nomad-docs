...
Python 2. Code is formatted close to [pep8](https://www.python.org/dev/peps/pep-0008/){:target="_blank" rel="noopener"},
critical parts use [pep484](https://www.python.org/dev/peps/pep-0484/){:target="_blank" rel="noopener"} type-hints.
[ruff](https://docs.astral.sh/ruff){:target="_blank" rel="noopener"}, and
[mypy](http://mypy-lang.org/){:target="_blank" rel="noopener"} (static type checker) are used to ensure quality.
Tests are written with [pytest](https://docs.pytest.org/en/latest/contents.html){:target="_blank" rel="noopener"}.
...
[Keycloak](https://www.keycloak.org/){:target="_blank" rel="noopener"} is used for user management. It manages users and
...
The ReSTful API is build with the [FastAPI](https://fastapi.tiangolo.com/){:target="_blank" rel="noopener"}
framework. This allows us to automatically derive a [OpenAPI](https://swagger.io/specification/){:target="_blank" rel="noopener"} description
of the nomad API.
...
[React](https://reactjs.org/docs/getting-started.html){:target="_blank" rel="noopener"} component framework.
...
efforts manageable. React uses [JSX](https://reactjs.org/docs/introducing-jsx.html){:target="_blank" rel="noopener"}
...
The container platform [Docker](https://docs.docker.com/){:target="_blank" rel="noopener"} allows us to provide all services
...
NOMAD as a software project is managed via [GitLab](https://docs.gitlab.com/){:target="_blank" rel="noopener"}.
The **nomad@FAIRDI** project is hosted [here](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR){:target="_blank" rel="noopener"}.
GitLab is used to manage versions, different branches of development, tasks and issues,
as a [registry for Docker images](https://docs.gitlab.com/ee/user/packages/container_registry/index.html){:target="_blank" rel="noopener"},
and [CI/CD platform](https://docs.gitlab.com/ee/ci/){:target="_blank" rel="noopener"}.
